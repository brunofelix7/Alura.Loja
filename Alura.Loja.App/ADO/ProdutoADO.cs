...
namespace Alura.Loja.App.ADO {

    internal class ProdutoADO : IDisposable {
        ...
        /* Atualiza um produto */
        internal void Update(Produto p) {
            try {
        ...
        /* Exclui um produto */
        internal void Remove(Produto p) {
            try {
